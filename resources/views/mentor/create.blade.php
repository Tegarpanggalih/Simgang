...
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="aprove_pembimbing" id="aprove_pembimbing" class="form-control" required>
                                    ...
                                    <option value="1" {{ old('aprove_pembimbing') == '1' ? 'selected' : '' }}>Disetujui
                                    </option>
                                    <option value="0" {{ old('aprove_pembimbing') == '0' ? 'selected' : '' }}>Belum
                                        Disetujui
                                    </option>
                                </select>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="approve_kadis" id="approve_kadis" class="form-control" required>
                                <option value="">Pilih Status</option>
                                <option value="1" {{ old('approve_kadis') == '1' ? 'selected' : '' }}>Disetujui
                                </option>
                                <option value="0" {{ old('approve_kadis') == '0' ? 'selected' : '' }}>Belum Disetujui
                                </option>
                            </select>
                            @error('approve_kadis')
                                <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="sts_diambil" id="sts_diambil" class="form-control" required>
                                ...
                                <option value="0" {{ old('sts_diambil') == '0' ? 'selected' : '' }}>Belum Diambil
                                </option>
                            </select>
                            @error('sts_diambil')
                                <small class="text-danger">{{ $message }}</small>
    ...
    <script>
        ...
        function nextStep(step) {
            document.querySelectorAll('.form-step').forEach((element) => element.style.display = 'none');
            ...
            progressBar.textContent = 'Langkah ' + step + ' dari 4';
        }
